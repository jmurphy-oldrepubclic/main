Attribute VB_Name = "sp_RequestData703"
Public Sub p_RequestData703()
...
wb(1).Sheets("Response7").Range("A32").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A42").Value = response_End_Loan
'
