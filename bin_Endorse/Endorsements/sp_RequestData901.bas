Attribute VB_Name = "sp_RequestData901"
Public Sub p_RequestData901()
...
wb(1).Sheets("Response9").Range("A30:A50").Clear
'MsgBox request.responseText
wb(1).Sheets("Response9").Range("A30").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A40").Value = response_End_Loan
