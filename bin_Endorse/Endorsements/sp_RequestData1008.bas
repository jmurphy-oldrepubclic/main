Attribute VB_Name = "sp_RequestData1008"
Public Sub p_RequestData1008()
...
newBody_End_Owners = .Range("A8").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A18").Value
