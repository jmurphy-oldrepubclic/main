Attribute VB_Name = "sp_RequestData808"
Public Sub p_RequestData808()
...
wb(1).Sheets("Response8").Range("A37").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A47").Value = response_End_Loan
'
