Attribute VB_Name = "sp_RequestData1007"
Public Sub p_RequestData1007()
...
newBody_End_Owners = .Range("A7").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A17").Value
