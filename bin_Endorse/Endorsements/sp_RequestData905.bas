Attribute VB_Name = "sp_RequestData905"
Public Sub p_RequestData905()
...
wb(1).Sheets("Response9").Range("A34").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A44").Value = response_End_Loan
'
