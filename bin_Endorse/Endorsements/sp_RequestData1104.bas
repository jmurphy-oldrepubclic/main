Attribute VB_Name = "sp_RequestData1104"
Public Sub p_RequestData1104()
...
wb(1).Sheets("Response11").Range("A33").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A43").Value = response_End_Loan
'
