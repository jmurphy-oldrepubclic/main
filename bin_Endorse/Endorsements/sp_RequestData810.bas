Attribute VB_Name = "sp_RequestData810"
Public Sub p_RequestData810()
...
wb(1).Sheets("Response8").Range("A39").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A49").Value = response_End_Loan
'
