Attribute VB_Name = "sp_RequestData704"
Public Sub p_RequestData704()
...
wb(1).Sheets("Response7").Range("A33").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A43").Value = response_End_Loan
'
