Attribute VB_Name = "sp_RequestData907"
Public Sub p_RequestData907()
...
wb(1).Sheets("Response9").Range("A36").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A46").Value = response_End_Loan
'
