Attribute VB_Name = "sp_RequestData1002"
Public Sub p_RequestData1002()
...
newBody_End_Owners = .Range("A2").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A12").Value
