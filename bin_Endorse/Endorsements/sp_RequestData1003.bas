Attribute VB_Name = "sp_RequestData1003"
Public Sub p_RequestData1003()
...
wb(1).Sheets("Response10").Range("A32").Value = response_End_Owners
wb(1).Sheets("Response10").Range("A42").Value = response_End_Loan
'
