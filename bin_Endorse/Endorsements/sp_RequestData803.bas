Attribute VB_Name = "sp_RequestData803"
Public Sub p_RequestData803()
...
wb(1).Sheets("Response8").Range("A32").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A42").Value = response_End_Loan
'
