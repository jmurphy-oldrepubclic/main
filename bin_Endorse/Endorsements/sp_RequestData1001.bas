Attribute VB_Name = "sp_RequestData1001"
Public Sub p_RequestData1001()
...
wb(1).Sheets("Response10").Range("A30:A50").Clear
'MsgBox request.responseText
wb(1).Sheets("Response10").Range("A30").Value = response_End_Owners
wb(1).Sheets("Response10").Range("A40").Value = response_End_Loan
