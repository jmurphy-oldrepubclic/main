Attribute VB_Name = "sp_RequestData804"
Public Sub p_RequestData804()
...
wb(1).Sheets("Response8").Range("A33").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A43").Value = response_End_Loan
'
