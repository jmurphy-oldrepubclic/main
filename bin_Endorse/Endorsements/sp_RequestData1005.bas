Attribute VB_Name = "sp_RequestData1005"
Public Sub p_RequestData1005()
...
newBody_End_Owners = .Range("A5").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A15").Value
