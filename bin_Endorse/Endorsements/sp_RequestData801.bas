Attribute VB_Name = "sp_RequestData801"
Public Sub p_RequestData801()
...
wb(1).Sheets("Response8").Range("A30:A50").Clear
'MsgBox request.responseText
wb(1).Sheets("Response8").Range("A30").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A40").Value = response_End_Loan
