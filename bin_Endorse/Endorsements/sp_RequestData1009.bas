Attribute VB_Name = "sp_RequestData1009"
Public Sub p_RequestData1009()
...
With wb(1).Sheets("Response10")
newBody_End_Owners = .Range("A9").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A19").Value
