Attribute VB_Name = "sp_RequestData705"
Public Sub p_RequestData705()
...
wb(1).Sheets("Response7").Range("A34").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A44").Value = response_End_Loan
'
