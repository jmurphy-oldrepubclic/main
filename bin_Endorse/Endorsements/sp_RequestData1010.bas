Attribute VB_Name = "sp_RequestData1010"
Public Sub p_RequestData1010()
...
newBody_End_Owners = .Range("A10").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A20").Value
...
wb(1).Sheets("Response10").Range("A39").Value = response_End_Owners
wb(1).Sheets("Response10").Range("A49").Value = response_End_Loan
'
Dim y1, y2, y3, y4 As Range

With wb(1).Sheets("Response10")
For Each y1 In .Range("A39")
