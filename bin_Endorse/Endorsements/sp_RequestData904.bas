Attribute VB_Name = "sp_RequestData904"
Public Sub p_RequestData904()
...
wb(1).Sheets("Response9").Range("A33").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A43").Value = response_End_Loan
'
