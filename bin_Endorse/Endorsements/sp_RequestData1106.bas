Attribute VB_Name = "sp_RequestData1106"
Public Sub p_RequestData1106()
...
wb(1).Sheets("Response11").Range("A35").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A45").Value = response_End_Loan
'
