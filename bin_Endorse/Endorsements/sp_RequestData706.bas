Attribute VB_Name = "sp_RequestData706"
Public Sub p_RequestData706()
...
wb(1).Sheets("Response7").Range("A35").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A45").Value = response_End_Loan
'
