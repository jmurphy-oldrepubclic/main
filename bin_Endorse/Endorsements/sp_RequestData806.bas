Attribute VB_Name = "sp_RequestData806"
Public Sub p_RequestData806()
...
wb(1).Sheets("Response8").Range("A35").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A45").Value = response_End_Loan
'
