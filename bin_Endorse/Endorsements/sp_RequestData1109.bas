Attribute VB_Name = "sp_RequestData1109"
Public Sub p_RequestData1109()
...
wb(1).Sheets("Response11").Range("A38").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A48").Value = response_End_Loan
'
