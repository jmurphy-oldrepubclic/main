Attribute VB_Name = "sp_RequestData702"
Public Sub p_RequestData702()
...
wb(1).Sheets("Response7").Range("A31").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A41").Value = response_End_Loan
'
