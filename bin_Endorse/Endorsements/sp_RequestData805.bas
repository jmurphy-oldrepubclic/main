Attribute VB_Name = "sp_RequestData805"
Public Sub p_RequestData805()
...
wb(1).Sheets("Response8").Range("A34").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A44").Value = response_End_Loan
'
