Attribute VB_Name = "sp_RequestData909"
Public Sub p_RequestData909()
...
wb(1).Sheets("Response9").Range("A38").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A48").Value = response_End_Loan
'
