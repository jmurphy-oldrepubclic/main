Attribute VB_Name = "sp_RequestData807"
Public Sub p_RequestData807()
...
wb(1).Sheets("Response8").Range("A36").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A46").Value = response_End_Loan
'
