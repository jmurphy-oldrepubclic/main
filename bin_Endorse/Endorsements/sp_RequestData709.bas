Attribute VB_Name = "sp_RequestData709"
Public Sub p_RequestData709()
...
wb(1).Sheets("Response7").Range("A38").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A48").Value = response_End_Loan
'
