Attribute VB_Name = "sp_RequestData1102"
Public Sub p_RequestData1102()
...
wb(1).Sheets("Response11").Range("A31").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A41").Value = response_End_Loan
'
