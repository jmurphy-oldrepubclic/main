Attribute VB_Name = "sp_RequestData802"
Public Sub p_RequestData802()
...
wb(1).Sheets("Response8").Range("A31").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A41").Value = response_End_Loan
'
