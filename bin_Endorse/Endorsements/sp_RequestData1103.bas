Attribute VB_Name = "sp_RequestData1103"
Public Sub p_RequestData1103()
...
wb(1).Sheets("Response11").Range("A32").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A42").Value = response_End_Loan
'
