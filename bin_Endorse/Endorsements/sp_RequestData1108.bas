Attribute VB_Name = "sp_RequestData1108"
Public Sub p_RequestData1108()
...
wb(1).Sheets("Response11").Range("A37").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A47").Value = response_End_Loan
'
