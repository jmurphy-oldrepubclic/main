Attribute VB_Name = "sp_RequestData708"
Public Sub p_RequestData708()
...
wb(1).Sheets("Response7").Range("A37").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A47").Value = response_End_Loan
'
