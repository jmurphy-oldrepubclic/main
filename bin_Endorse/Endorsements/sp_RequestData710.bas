Attribute VB_Name = "sp_RequestData710"
Public Sub p_RequestData710()
...
wb(1).Sheets("Response7").Range("A39").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A49").Value = response_End_Loan
'
