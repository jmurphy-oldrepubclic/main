Attribute VB_Name = "sp_RequestData1107"
Public Sub p_RequestData1107()
...
wb(1).Sheets("Response11").Range("A36").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A46").Value = response_End_Loan
'
