Attribute VB_Name = "sp_RequestData1006"
Public Sub p_RequestData1006()
...
newBody_End_Owners = .Range("A6").Value
allBody_End_Owners = newBody_End_Owners
newBody_End_Loan = .Range("A16").Value
