Attribute VB_Name = "sp_RequestData902"
Public Sub p_RequestData902()
...
wb(1).Sheets("Response9").Range("A31").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A41").Value = response_End_Loan
'
