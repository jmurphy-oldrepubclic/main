Attribute VB_Name = "sp_RequestData906"
Public Sub p_RequestData906()
...
wb(1).Sheets("Response9").Range("A35").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A45").Value = response_End_Loan
'
