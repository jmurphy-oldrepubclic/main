Attribute VB_Name = "sp_RequestData1110"
Public Sub p_RequestData1110()
...
wb(1).Sheets("Response11").Range("A39").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A49").Value = response_End_Loan
'
