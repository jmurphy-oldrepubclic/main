Attribute VB_Name = "sp_RequestData908"
Public Sub p_RequestData908()
...
wb(1).Sheets("Response9").Range("A37").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A47").Value = response_End_Loan
'
