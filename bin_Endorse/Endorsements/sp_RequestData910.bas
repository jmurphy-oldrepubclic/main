Attribute VB_Name = "sp_RequestData910"
Public Sub p_RequestData910()
...
wb(1).Sheets("Response9").Range("A39").Value = response_End_Owners
wb(1).Sheets("Response9").Range("A49").Value = response_End_Loan
'
