Attribute VB_Name = "sp_RequestData707"
Public Sub p_RequestData707()
...
wb(1).Sheets("Response7").Range("A36").Value = response_End_Owners
wb(1).Sheets("Response7").Range("A46").Value = response_End_Loan
'
