Attribute VB_Name = "sp_RequestData809"
Public Sub p_RequestData809()
...
wb(1).Sheets("Response8").Range("A38").Value = response_End_Owners
wb(1).Sheets("Response8").Range("A48").Value = response_End_Loan
'
