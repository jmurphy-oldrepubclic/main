Attribute VB_Name = "sp_RequestData1105"
Public Sub p_RequestData1105()
...
wb(1).Sheets("Response11").Range("A34").Value = response_End_Owners
wb(1).Sheets("Response11").Range("A44").Value = response_End_Loan
'
