Attribute VB_Name = "sp_RequestData604"
Public Sub p_RequestData604()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A4").Value
...
wb(1).Sheets("Response6").Range("A36:A37").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A36")
