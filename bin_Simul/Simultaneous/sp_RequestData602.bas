Attribute VB_Name = "sp_RequestData602"
Public Sub p_RequestData602()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A2").Value
...
wb(1).Sheets("Response6").Range("A32:A33").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A32")
