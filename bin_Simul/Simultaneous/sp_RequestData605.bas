Attribute VB_Name = "sp_RequestData605"
Public Sub p_RequestData605()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A5").Value
...
wb(1).Sheets("Response6").Range("A38:A39").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A38")
