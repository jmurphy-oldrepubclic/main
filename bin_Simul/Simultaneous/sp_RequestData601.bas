Attribute VB_Name = "sp_RequestData601"
Public Sub p_RequestData601()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A1").Value
...
wb(1).Sheets("Response6").Range("A30:A50").Clear
'MsgBox request.responseText
wb(1).Sheets("Response6").Range("A30:A31").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A30")
