Attribute VB_Name = "sp_RequestData603"
Public Sub p_RequestData603()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A3").Value
...
wb(1).Sheets("Response6").Range("A34:A35").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A34")
