Attribute VB_Name = "sp_RequestData606"
Public Sub p_RequestData606()
...
'What do you want to analyze?
  myTxt = wb(1).Sheets("Response6").Range("A6").Value
...
wb(1).Sheets("Response6").Range("A40:A41").Value = response_Simult

Dim y1 As Range
Dim a1 As Range

With wb(1).Sheets("Response6")
For Each a1 In .Range("A40")
     If InStr(a1.Value, "Endorsements") > 0 Then
        a1.Value = Right(a1.Value, InStr(a1.Value, "Endorsements") + 190)
    End If
Next a1

For Each y1 In .Range("A40")
