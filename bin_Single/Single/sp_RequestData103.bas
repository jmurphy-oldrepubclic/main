Attribute VB_Name = "sp_RequestData103"
Public Sub p_RequestData103()
...
.Range("A17").Value = Replace(var3, "Calculated", "")

var4 = .Range("A17").Value
.Range("A17").Value = Replace(var4, "Premium", "")

var6 = .Range("A17").Value
.Range("A17").Value = Replace(var6, ":", "")
