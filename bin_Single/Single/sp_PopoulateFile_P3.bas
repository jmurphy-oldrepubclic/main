...
With wb(2).Worksheets("Response3")
...
Application.ScreenUpdating = False
  ...
  Call p_FormatFile_P3
  Call p_CompareResults_P3
  Call p_CheckMessages_P3
  Call p_StampFile_P3
