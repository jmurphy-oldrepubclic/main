Attribute VB_Name = "sp_RequestData208"
Public Sub p_RequestData208()
...
.Range("A22").Value = response

Dim y As Range
Dim a As Range
Dim var As String

For Each a In .Range("A22")
...
For Each y In .Range("A22")
     If InStr(y.Value, "Calculated") > 0 Then
        y.Value = Left(y.Value, InStr(y.Value, "Endorsements") - 23)
    End If
Next y

var1 = .Range("A22").Value
.Range("A22").Value = Replace(var1, ":null", "")

var2 = .Range("A22").Value
.Range("A22").Value = Replace(var2, "NetPremium", "")

var3 = .Range("A22").Value
.Range("A22").Value = Replace(var3, "Calculated", "")

var4 = .Range("A22").Value
.Range("A22").Value = Replace(var4, "Premium", "")

var6 = .Range("A22").Value
.Range("A22").Value = Replace(var6, ":", "")
