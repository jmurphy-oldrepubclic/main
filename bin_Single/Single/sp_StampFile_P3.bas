Attribute VB_Name = "sp_StampFile_P3"
Public Sub p_StampFile_P3()
...
wb(2).Worksheets("Single Policy Inputs").Range("E4").Copy
wb(1).Worksheets(1).Range("G1:I1").PasteSpecial
wb(2).Worksheets("Single Policy Inputs").Range("B4").Copy
wb(1).Worksheets(1).Range("H3").PasteSpecial
wb(2).Worksheets("Single Policy Inputs").Range("K4").Copy
