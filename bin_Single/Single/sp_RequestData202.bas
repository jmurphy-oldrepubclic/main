Attribute VB_Name = "sp_RequestData202"
Public Sub p_RequestData202()
...
For Each y In .Range("A16")
     If InStr(y.Value, "Calculated") > 0 Then
        y.Value = Left(y.Value, InStr(y.Value, "Endorsements") - 23)
    End If
Next y

var1 = .Range("A16").Value
.Range("A16").Value = Replace(var1, ":null", "")

var2 = .Range("A16").Value
.Range("A16").Value = Replace(var2, "NetPremium", "")

var3 = .Range("A16").Value
.Range("A16").Value = Replace(var3, "Calculated", "")

var4 = .Range("A16").Value
.Range("A16").Value = Replace(var4, "Premium", "")

var6 = .Range("A16").Value
.Range("A16").Value = Replace(var6, ":", "")
