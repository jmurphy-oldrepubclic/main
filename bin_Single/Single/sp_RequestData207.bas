Attribute VB_Name = "sp_RequestData207"
Public Sub p_RequestData207()
...
With wb(1).Sheets("Response2")
newBody = .Range("A7").Value
allBody = newBody
...
.Range("A21").Value = response

Dim y As Range
Dim a As Range
Dim var As String

For Each a In .Range("A21")
...
For Each y In .Range("A21")
     If InStr(y.Value, "Calculated") > 0 Then
        y.Value = Left(y.Value, InStr(y.Value, "Endorsements") - 23)
    End If
Next y

var1 = .Range("A21").Value
.Range("A21").Value = Replace(var1, ":null", "")

var2 = .Range("A21").Value
.Range("A21").Value = Replace(var2, "NetPremium", "")

var3 = .Range("A21").Value
.Range("A21").Value = Replace(var3, "Calculated", "")

var4 = .Range("A21").Value
.Range("A21").Value = Replace(var4, "Premium", "")

var6 = .Range("A21").Value
.Range("A21").Value = Replace(var6, ":", "")
