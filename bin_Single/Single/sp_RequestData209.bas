Attribute VB_Name = "sp_RequestData209"
Public Sub p_RequestData209()
...
.Range("A23").Value = Replace(var3, "Calculated", "")

var4 = .Range("A23").Value
.Range("A23").Value = Replace(var4, "Premium", "")

var6 = .Range("A23").Value
.Range("A23").Value = Replace(var6, ":", "")
