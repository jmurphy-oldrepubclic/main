Attribute VB_Name = "sp_RequestData201"
Public Sub p_RequestData201()
...
var1 = .Range("A15").Value
.Range("A15").Value = Replace(var1, ":null", "")

var2 = .Range("A15").Value
.Range("A15").Value = Replace(var2, "NetPremium", "")

var3 = .Range("A15").Value
.Range("A15").Value = Replace(var3, "Calculated", "")

var4 = .Range("A15").Value
.Range("A15").Value = Replace(var4, "Premium", "")

var6 = .Range("A15").Value
.Range("A15").Value = Replace(var6, ":", "")
