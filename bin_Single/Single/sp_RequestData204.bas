Attribute VB_Name = "sp_RequestData204"
Public Sub p_RequestData204()
...
.Range("A18").Value = Replace(var3, "Calculated", "")

var4 = .Range("A18").Value
.Range("A18").Value = Replace(var4, "Premium", "")

var6 = .Range("A18").Value
.Range("A18").Value = Replace(var6, ":", "")
