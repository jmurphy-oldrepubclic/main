...
With wb(2).Worksheets("Response5")
...
Application.ScreenUpdating = False
  ...
  Call p_FormatFile_P5
  Call p_CompareResults_P5
  Call p_CheckMessages_P5
  Call p_StampFile_P5
