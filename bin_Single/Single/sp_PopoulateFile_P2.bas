...
With wb(2).Worksheets("Response2")
...
Application.ScreenUpdating = False
  ...
  Call p_FormatFile_P2
  Call p_CompareResults_P2
  Call p_CheckMessages_P2
  Call p_StampFile_P2
